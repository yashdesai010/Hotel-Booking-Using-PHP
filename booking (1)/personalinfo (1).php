...
?>
		...
		<form class="form-horizontal" action="personalinfo.php" method="post"  name="personal" >    
					  ...
					  <div class="form-group">
			            <div class="col-md-12">
			              ...
			              <div class="col-md-12">
			                ...
			                <input name="name" type="text" class="form-control input-sm" id="name"  maxlength="32" pattern="[A-Za-z]{1,32}" />
			              </div>
			            </div>
			          </div> 
			            ...
			            <div class="col-md-12">
			              ...
			              <div class="col-md-12">
			                <input name="last" type="text" class="form-control input-sm" id="last" maxlength="32" pattern="[A-Za-z]{1,32}" />
			              </div>
			            </div>
			          </div>
			           ...
			           <div class="form-group">
			            <div class="col-md-12">
			              ...
			              <div class="col-md-12">
			                <input name="city" type="text" class="form-control input-sm" id="city" maxlength="32" pattern="[A-Za-z]{1,32}" />
			              </div>
			            </div>
			          </div>
			           <div class="form-group">
			           ...
			           <div class="form-group">
			            <div class="col-md-12">
			              ...
			              <div class="col-md-12">
			                <input name="phone" type="tel" class="form-control input-sm" id="phone" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"/>
			              </div>
			            </div>
			           </div>
			          ...
			          <div class="form-group">
			            <div class="col-md-12">
			              <label class="col-md-4 control-label" for=
			              "password">PASSWORD:MINIMUM 4 LENGTH</label>

			              <div class="col-md-12">
			                <input name="pass" type="password" class="form-control input-sm" id="password" minlength="4" />
			              </div>
			            </div>
			          </div>
			          ...
			          <div class="form-group">
			            <div class="col-md-12">
			              ...
			              <div class="col-md-12">
			                <input name="zip" type="number" class="form-control input-sm" id="zip" />
			              </div>
			            </div>
			          </div>
